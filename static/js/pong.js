...
Pong = {
  ...
  Menu: {
    ...
    initialize: function(pong) {
      var press1 = pong.images[url_press1];
      var press2 = pong.images[url_press2];
      var winner = pong.images[url_winner];
  ...
  Sounds: {
    ...
    initialize: function(pong) {
      ...
      if (this.supported) {
        this.files = {
          ping: Game.createAudio(url_ping),
          pong: Game.createAudio(url_pong),
          wall: Game.createAudio(url_wall),
          goal: Game.createAudio(url_goal)
        };
      }
    },
